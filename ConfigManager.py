...
class ConfigManager:
    ...
    redmineTrelloConfiguration = None
    ...
    def loadConfigurationFromFiles(self):
        if self.redmineTrelloConfiguration is None:
            try:
                ...
                return self.loadAPIKeys(APIKeyFile_string)
        ...
        return self.redmineTrelloConfiguration
    ...
    def createAPIFile(self, file_string):
        ...
        APIKeys["token_expiration"] = "1day"
        print "token expiration is set to:", APIKeys["token_expiration"]

        # generate tokens
        APIKeys["oauth_token"] = TrelloManager.TrelloManager().get_oauth_token_and_secret(APIKeys["trello_api_key"],
